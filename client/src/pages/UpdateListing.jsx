...
export default function CreateListing() {
  ...
  useEffect(() => {
    ...
    fetchListingData(); // ✅ Call the function
  }, [params.listingId]); // ✅ Add dependency to re-fetch if the ID changes
  ...
  return (
    <main className="p-6 max-w-5xl mx-auto bg-white rounded-2xl shadow-lg">
      ...
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-bold text-slate-800">Update a Listing</h1>
